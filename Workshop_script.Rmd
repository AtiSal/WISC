---
title: "WISC & Data Science Club RNA-seq analysis workshop, Fall 2020"
date: "06/11/2020"
...
```{r}
# We extract top 500 genes for over-representation analysis
Genelist <- resOrdered@rownames[1:500]

# We use BP -- represents Biological Processes for downstream analysis in GO database 
...
* [Introduction to R, Rstudio, Git and more.](https://software-carpentry.org/lessons/)
